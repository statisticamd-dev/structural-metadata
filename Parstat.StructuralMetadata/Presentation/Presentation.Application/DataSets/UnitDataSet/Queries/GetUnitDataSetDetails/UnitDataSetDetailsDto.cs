...
{
    public class UnitDataSetDetailsDto : AbstractIdentifiableArtefactDto, IMapFrom<DataSet>
    {
        ...
        public void Mapping(Profile profile)
        {
            ...
            //default english
            string language = "en";
            profile.CreateMap<DataSet, UnitDataSetDetailsDto>()
                ...
                /* .ForMember(d => d.Structure, opt => opt.MapFrom(s => s.Structure)) */;
        }
