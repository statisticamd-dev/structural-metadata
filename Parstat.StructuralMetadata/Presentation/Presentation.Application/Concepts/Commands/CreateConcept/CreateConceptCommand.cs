...
{
    public class CreateConceptCommand : AbstractRequest, IRequest<long>
    {
        ...
        public class Handler : IRequestHandler<CreateConceptCommand, long>
        {
            ...
            public async Task<long> Handle(CreateConceptCommand request, CancellationToken cancellationToken)
            {
                Language language;
