...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ComponentLogicalRecord", b =>
                {
                    b.Property<long>("ComponentsId")
                        .HasColumnType("bigint");

                    b.Property<long>("RecordsId")
                        .HasColumnType("bigint");

                    b.HasKey("ComponentsId", "RecordsId");

                    b.HasIndex("RecordsId");

                    b.ToTable("ComponentLogicalRecord");
                });
            ...
            modelBuilder.Entity("Presentation.Domain.StructuralMetadata.Entities.Gsim.Structure.Component", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("RepresentedVariableId");
            ...
            modelBuilder.Entity("Presentation.Domain.StructuralMetadata.Entities.Gsim.Structure.DataSet", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("ExchangeChannel")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<DateTime?>("ReportingBegin")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("ReportingEnd")
                        .HasColumnType("timestamp without time zone");

                    b.Property<long>("StatisticalProgramId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Presentation.Domain.StructuralMetadata.Entities.Gsim.Structure.DataStructure", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Presentation.Domain.StructuralMetadata.Entities.Gsim.Structure.LogicalRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Presentation.Domain.StructuralMetadata.Entities.Tags.EntityTag", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Presentation.Domain.StructuralMetadata.Entities.Tags.Tag", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("ComponentLogicalRecord", b =>
                {
                    b.HasOne("Presentation.Domain.StructuralMetadata.Entities.Gsim.Structure.Component", null)
                        .WithMany()
                        .HasForeignKey("ComponentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Presentation.Domain.StructuralMetadata.Entities.Gsim.Structure.LogicalRecord", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Presentation.Domain.StructuralMetadata.Entities.Gsim.Structure.Component", b =>
                {
                    b.HasOne("Presentation.Domain.StructuralMetadata.Entities.Gsim.Structure.DataStructure", "DataStructure")
                        .WithMany("Components")
                        .HasForeignKey("DataStructureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Presentation.Domain.StructuralMetadata.Entities.Gsim.Structure.DataSet", b =>
                {
                    b.HasOne("Presentation.Domain.StructuralMetadata.Entities.Gsim.Structure.DataStructure", "Structure")
                        .WithMany("DataSets")
            ...
            modelBuilder.Entity("Presentation.Domain.StructuralMetadata.Entities.Gsim.Structure.DataStructure", b =>
                {
                    b.OwnsOne("Presentation.Domain.MultilanguageString", "Description", b1 =>
                        {
                            b1.Property<long>("DataStructureId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bigint")
                                .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                            ...
                            b1.HasKey("DataStructureId");

                            b1.ToTable("DataStructures");
            ...
            modelBuilder.Entity("Presentation.Domain.StructuralMetadata.Entities.Gsim.Structure.LogicalRecord", b =>
                {
                    ...
                    b.OwnsOne("Presentation.Domain.MultilanguageString", "Description", b1 =>
                        {
                            b1.Property<long>("LogicalRecordId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bigint")
                                .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                            ...
                            b1.HasKey("LogicalRecordId");

                            b1.ToTable("LogicalRecords");

                            b1.WithOwner()
                                .HasForeignKey("LogicalRecordId");
                        });
            ...
            modelBuilder.Entity("Presentation.Domain.StructuralMetadata.Entities.Tags.EntityTag", b =>
                {
                    b.HasOne("Presentation.Domain.StructuralMetadata.Entities.Tags.Tag", "Tag")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Presentation.Domain.StructuralMetadata.Entities.Tags.Tag", b =>
                {
                    b.HasOne("Presentation.Domain.StructuralMetadata.Entities.Tags.Tag", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
